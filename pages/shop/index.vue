				...
				<div class="row">
					...
					<div class="col-12 col-lg-4 col-md-6 col-projects d-flex"
						...
						<nuxt-link class="block-project" :to="localePath({name: 'slug', params: {slug: project.id}})">
							<div class="thumbnail" :style="{backgroundImage: `url('${project.img}')`}">
							...
							<div class="info">
								<div class="d-flex justify-content-between align-items-center">
									<div class="name">
										...
										<div class="client text-overflow">{{project.cost}}</div>
									</div>
									<div class="showUp">
								...
								<div class="description">
									<div class="shortDes">{{project.quantities}}</div>
									<div class="showUp">
...
export default {
    ...
    methods: {
		...
		findData() {
			...
			this.isLoading = true;
			this.$store.dispatch('shop/fetch').then(paging => {
