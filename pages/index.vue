				...
				<div class="row">
					...
					<div class="col-12 col-lg-4 col-md-6 col-projects d-flex"
						...
						<nuxt-link class="block-project" :to="localePath({name: 'slug', params: {slug: project.id}})">
							<div class="thumbnail" :style="{backgroundImage: `url('https://magento2.officience.com/indemo_be/${project.thumb_small}')`}">
							...
							<div class="info">
								<div class="d-flex justify-content-between align-items-center">
									<div class="name">
										...
										<div class="client text-overflow">{{project.client}}</div>
									</div>
									<div class="showUp">
								...
								<div class="description">
									<div class="shortDes">{{project.short_desc}}</div>
									<div class="showUp">
    ...
    methods: {
		...
		findData() {
			...
			this.$store.dispatch('projects/fetch', {
				...
				if (paging.data.data && paging.data.data.length) {
					this.isLoading = false;
					this.currentIndex = paging.data.length < this.pageSize ? -1 : this.currentIndex + 1;
