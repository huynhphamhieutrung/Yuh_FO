						...
						<nuxt-link class="block-project" :to="localePath({name: 'slug', params: {slug: project.id}})">
							...
							<div class="info">
								<div class="d-flex justify-content-between align-items-center">
									<div class="name">
										<div class="project text-overflow">{{project.title}}</div>
										<div class="client text-overflow">{{project.type}}</div>
									</div>
									<div class="showUp">
								...
								<div class="description">
									<div class="shortDes">{{project.description}}</div>
									<div class="showUp">
...
export default {
    ...
    methods: {
		...
		findData() {
			...
			this.isLoading = true;
			this.$store.dispatch('missions/fetch').then(paging => {
